...
const EDITABLE_ROLES: { value: AccountRole; label: string; hint: string }[] = [
  { value: 'admin', label: 'Administrador', hint: 'Gerencia membros + tudo' },
  { value: 'agent', label: 'Agente', hint: 'Usa funcionalidades; sem configurações' },
          ...
          return (
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
              ...
              <span className="inline-flex items-center gap-1.5">
                ...
                {counts.away} ausente{counts.away === 1 ? '' : 's'}
              </span>
              <span className="inline-flex items-center gap-1.5">
        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              A URL de convite é exibida apenas uma vez por segurança — para reenviar, revogue o convite abaixo e crie um novo.
            </p>
          ) : null}
        ...
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              da conta? Ele será desconectado desta conta e receberá uma nova conta pessoal no próximo acesso. O login não é excluído.
            </DialogDescription>
          </DialogHeader>
